...
(function () {
    ...
    CommonObject.prototype.renderPromoteModule = function (promoteArr) {
        ...
        if (query.type == 1) {
            wx_text = '微信';
            wx_url = 'weixin://';
            wx_logo = "/h5/wangzhuan9/images/wx.gif";
    ...
    CommonObject.prototype.initQuestionAnswer = function () {
        ...
        try {
            if (document.querySelectorAll(".swiper-confirm-button")[0]) {
                document.querySelectorAll(".swiper-confirm-button")[0].addEventListener('click',function(){
